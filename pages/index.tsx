      ...
      <section className=" bg-gray-200">
        <div className={clsx(
          ...
          {products?.map((product, index) => {
            return <div key={product.id} className={clsx(layout === "grid" && "flex-col", "mt-5 flex bg-white")}>
