...
function ProductDetails() {
    ...
    return <div className="">
        <div className="flex bg-gray-200 justify-center p-12">
            {/* Image  */}
            <div className="bg-white w-auto h-auto flex container py-6">
                ...
                <div className="pl-6">
                    ...
                    {/* Price */}
                    <h1 className="text-neutral-400 text-sm text-gray-200">Price</h1>
                    {/* Price & discount */}
